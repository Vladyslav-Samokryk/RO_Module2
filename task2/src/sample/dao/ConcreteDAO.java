...
public abstract class ConcreteDAO implements DAO {
    ...
    @Override
    public void updatePlanetInfo(int code, int rad, String newName, int temp, String atm, String life, String satel) {
        try {
            stmt = conn.createStatement();
            String sql;
            sql = " update planetInfo set code=" + rad + ", name=\"" + newName + "\" where code=" + temp + atm + life + satel + ";";
    ...
    public abstract void updatePlanetInfo(String name, int code, int newCode, String newAtm, String newName, int newSat);

    public abstract void addPlanetInfo(int i, String s, int code, String atm, String life, String name);
    ...
    @Override
    public void deleteSatelite(String name, int rad, int distance) {
        try {
            stmt = conn.createStatement();
            String sql;
            sql = "delete from satelite where name = " + name + " and airCode=" + rad + distance + ";";
            int status = stmt.executeUpdate(sql);
            if(status < 0){
                System.out.println("Error");
            }
