...
public class Controller {
    ...
    public void printToTreeView() throws RemoteException {
        treeView.setRoot(null);
        treeView.setRoot(null);
        ArrayList<PlanetInfo> planets = client.getAll().getPlanetInfo();
    ...
    private void addPlanett(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        client.addPlanetInfo(Integer.valueOf(code), name);
        printToTreeView();
    }
    @FXML
    private void addSatelite(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        //PlanetInfo aircompany = xmlWorker.findPlanetInfoByCode(Integer.valueOf(codePlanetInfo));
    ...
    private void updatePlanet(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        client.updatePlanet(Integer.valueOf(codePlanetInfo), Integer.valueOf(newCode), newName, newTemp, newAtm, newLife, newSat);
        printToTreeView();
    }
    @FXML
    ...
    public void deletePlanett(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        String codePlanetInfo = selectedItem.getValue().split(" ")[1];
        client.deletePlanet(Integer.valueOf(codePlanetInfo));
        printToTreeView();
    }
    @FXML
